...
<div class="wrap_header">
    ...
    <div class="header-icons">
        ...
        <a href="<?php echo base_url('dasbor') ?>" class="header-wrapicon1 dis-block">
            <img src="<?php echo base_url() ?>assets/template/images/icons/icon-header-01.png" class="header-icon1" alt="ICON"> <?php echo $this->session->userdata('nama_customer'); ?>&nbsp; &nbsp;
        </a>
        ...
        <?php }else{ ?>
        <a href="<?php echo base_url('daftar') ?>" class="header-wrapicon1 dis-block">
    ...
    <ul class="main-menu">
        ...
        <li class="item-menu-mobile">
            ...
            <ul class="sub-menu">
                ...
                <li><a href="<?php base_url('produk/kategori/'.$nav_produk_mobile->slug_kategori) ?>">
