...
<div class="bgwhite">
	...
	<div class="col-md-12">
		...
		// form open
		echo form_open(base_url('daftar'), 'class="leave-comment"'); ?>

		<table class="table">
			<thead>
				<tr>
					<th width="25%">Nama</th>
					<th><input type="text" name="nama_customer" class="form-control" placeholder="Nama lengkap" value="<?php echo set_value('nama_customer') ?>" required></th>
				</tr>
			</thead>
			<tbody>
				<tr>
