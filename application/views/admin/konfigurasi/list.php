...
<div class="form-group">
  ...
  <div class="col-md-8">
    <input type="text" name="tagline" class="form-control" placeholder="Tagline/Moto" value=
...
<div class="form-group">
  <label class="col-md-3 control-label">Alamat Produksi</label>
  <div class="col-md-9">
    <textarea name="alamat" class="form-control" placeholder="Alamat Produksi"
