...
<div class="form-group">
  ...
  <div class="col-md-5">
    ...
    "<?php echo $rekening->nama_bank ?>" required>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="number" name="nomor_rekening" class="form-control"  placeholder="Nomor Rekening" value=
    "<?php echo $rekening->nomor_rekening?>" requied>  
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-5">
    <input type="text" name="nama_pemilik" class="form-control"  placeholder="Nama Pemilik Rekening" value=
    "<?php echo $rekening->nama_pemilik?>" requied>  
  </div>
</div>
