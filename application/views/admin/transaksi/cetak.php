	...
	<div class="cetak">
		...
		<thead>
			<tr>
				...
				<th>: <?php echo $header_transaksi->nama_customer ?></th>
			</tr>
			<tr>
		...
		<tbody>
			...
			<tr>
				...
				<td>: <?php echo $header_transaksi->nama_bank ?> No. rekening <?php echo $header_transaksi->rekening_pembayaran ?> a.n <?php echo $header_transaksi->rekening_customer ?></td>
			</tr>
			<tr>
				<td>Pembayaran ke rekening</td>
				<td>: <?php echo $header_transaksi->nama_bank ?> No. rekening <?php echo $header_transaksi->nomor_rekening ?> a.n <?php echo $header_transaksi->nama_pemilik ?></td>
			</tr>
		</tbody>
		</table>
